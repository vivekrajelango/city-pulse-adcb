            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className={`w-full px-4 py-3 border text-gray-800 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors ${getTextAlignClass(language)}`}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleInputChange}
                  required
                  className={`w-full px-4 py-3 text-gray-800 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors ${getTextAlignClass(language)}`}
